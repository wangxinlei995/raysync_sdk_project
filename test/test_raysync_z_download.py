...
import time
from public.public  import upload_task,statechanged_func
...
class TestRaysyncDownload(unittest.TestCase):
    ...
    def test_download_1(self):
        ...
        self.assertTrue(os.path.exists(DOWNLOAD_PATH + '\\167-mov.mov'))
    ...
    def test_download_3(self):
        ...
        self.lib.Raysync_Upload(self.instance,bytes(DOWNLOAD_PATH, encoding='utf8') , '/' , files , None , 'download_task_3')
